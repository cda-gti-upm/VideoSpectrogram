...
# TODO: no funciona bien la representación de las trazas combinadas
...
# Read in all files starting with dis.
st2 = obspy.read("https://examples.obspy.org/dis.G.SCZ.__.BHE")
st2 += obspy.read("https://examples.obspy.org/dis.G.SCZ.__.BHE.1")
st2 += obspy.read("https://examples.obspy.org/dis.G.SCZ.__.BHE.2")

# sort
st2.sort(['starttime'])

# Go through the stream object and plot the data with a shared x axis
fig2, axes2 = plt.subplots(nrows=len(st2)+1, sharex=True)
ax = None
