...
# takes a dict of attribute name/value pairs and sets LTSA params accordingly
    ...
    def _init_params(self):
        ...
        self.div_len = int(np.round(self.fs*10))  # ten second divisions
...
class seismicLTSA(LTSA):
    '''
    Long-Term Spectral Average

    A class for computing spectral visualizations of long seismic signals.

    Inputs:

    *raw*
    One-dimensional, real numpy array containing the raw seismic data

    *fs*
    Sampling frequency in Hertz, defaults to 250
