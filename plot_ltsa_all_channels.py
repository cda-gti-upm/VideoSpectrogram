...
def prepare_fig(tr, prefix_name, a_min, a_max, lf, hf, fig, ax):
    print(f'Preparing figure...')

    """
    fig.suptitle(f'{prefix_name} {tr.meta.network}, {tr.meta.station}, {tr.meta.location}, Channel {tr.meta.channel} '
...
if __name__ == "__main__":
    ...
    for i, par in enumerate(par_list):
        ...
        # Prepare figure
        j = i*2
        fig, ax[j:j+2] = prepare_fig(tr, 'LTSA', a_min, a_max, Low_frequency, High_frequency, fig, ax[j:j+2])
    ...
    save_figure2(path_output, 'LTSA', tr_info, fig, fig_format)
